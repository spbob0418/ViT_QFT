...
import quant_vision_transformer_pertensor
...
DIST_PORT=6006
WANDB_LOG = True
WANDB_PROJ_NAME = 'DeiT_finegrained_new_lr'
...
class ConstantLRScheduler(torch.optim.lr_scheduler._LRScheduler):
    def __init__(self, optimizer, fixed_lr, last_epoch=-1):
        self.fixed_lr = fixed_lr
        super(ConstantLRScheduler, self).__init__(optimizer, last_epoch)

    def get_lr(self):
        # Always return the fixed learning rate
...
def main(args):
    ...
    lr_scheduler = ConstantLRScheduler(optimizer, fixed_lr=0.000001)
